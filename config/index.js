...
//Logs incoming requests and responses to the terminal (useful for debugging)
const logger = require("morgan");

//Allows the server to accept requests from different origins (e.g., frontend apps)
